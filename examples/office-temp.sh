...
note "Drove the kitchen sensor through two cool/hot cycles of 60 samples each. The 60-tick moving average crosses 28.0 twice, so we get two 'hot' edges, two 'cool' edges, and a crossing count that reaches 2."
